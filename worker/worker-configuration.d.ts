/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false` (hash: f0298bb2cb3a3c4d5eab731fe5819bdd)
// Runtime types generated with workerd@1.20260708.1 2026-07-13 nodejs_compat
interface __BaseEnv_Env {
	LOG_WEBHOOK_PAYLOADS: string;
	THREADS_APP_ID: string;
	THREADS_OAUTH_REDIRECT_URI: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_WEBHOOK_PAYLOADS" | "THREADS_APP_ID" | "THREADS_OAUTH_REDIRECT_URI" | "META_APP_SECRET" | "META_WEBHOOK_VERIFY_TOKEN" | "SUPABASE_URL" | "SUPABASE_SERVICE_ROLE_KEY">> {}
}
